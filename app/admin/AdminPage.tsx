...
function AdminPage({ data }: Props) {
  ...
  return (
    <div className="relative flex">
      ...
      <div className="flex w-full flex-col  items-center justify-center gap-3  px-3 pt-6 shadow-lg sm:grid sm:items-start md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
